...
async def delayspam(client: Client, message: Message):
    if message.chat.id in GROUP:
        return await message.reply_text(
            "**❍ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ʙᴇ ᴜsᴇᴅ ɪɴ ᴛʜɪs ɢʀᴏᴜᴘ**"
        )
...
async def spam_stick(client: Client, message: Message):
    if message.chat.id in GROUP:
        return await message.reply_text(
            "**❍ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ʙᴇ ᴜsᴇᴅ ɪɴ ᴛʜɪs group**"
        )
    if not message.reply_to_message:
        await message.reply_text(
            "**❍ ʀᴇᴘʟʏ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ ᴡɪᴛʜ ᴀᴍᴏᴜɴᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ sᴘᴀᴍ**"
        )
        return
...
__MENU__ = """
      ...
      `.pspam` - .sᴘᴀᴍ (ᴄᴏᴜɴᴛ) (ᴍᴇssᴀɢᴇ)
`.sspam` - .ssᴘᴀᴍ (ᴄᴏᴜɴᴛ) (ʀᴇᴘʟʏ_ᴍᴇᴅɪᴀ)
`.delayspam` - .ᴅᴇʟᴀʏsᴘᴀᴍ (ᴛɪᴍᴇ ɪɴ sᴇᴄᴏɴᴅ) (ᴄᴏᴜɴᴛ) (ᴛᴇxᴛ)
   `.randi .randii` - .ᴏɴᴇ ᴡᴏʀᴅ sᴘᴀᴍ sᴛᴀʀᴛ
      `.stop` - . ᴏɴᴇ ᴡᴏʀᴅ sᴘᴀᴍ sᴛᴏᴘ
"""
