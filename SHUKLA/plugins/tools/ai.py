        ...
        if len(message.command) < 2:
            ...
            try:
                ...
                if "answer" in response.json():
                    ...
                    await message.reply_text(
                        f" {x}      ᴀɴsᴡᴇʀɪɴɢ ʙʏ ➛  @II_SANATANI_II",
                        parse_mode=ParseMode.MARKDOWN
                    )
                else:
                    await message.reply_text("ɴᴏ 'ʀᴇsᴜʟᴛs ᴋᴇʏ ғᴏᴜɴᴅ ɪɴ ᴛʜᴇ ʀᴇsᴘᴏɴsᴇ.")
            except KeyError:
...
__NAME__ = " Aɪ Cʜᴀᴛɢᴘᴛ"
__MENU__ = """
`.ai` - **ᴇxᴀᴍᴘʟᴇ:.ᴄʜᴀᴛɢᴘᴛ ᴡʜᴇʀᴇ ɪs ᴘᴜɴᴊᴀʙ?.**
`.cc` - **sᴏᴍᴇ ʟɪᴠᴇ ɢᴇɴᴇʀᴀᴛᴇᴅ ᴄᴄ.**
`.image` - **ɢɪᴠᴇ ɪᴍᴀɢᴇ ɴᴀᴍᴇ ғᴏʀ sᴇᴀʀᴄʜ .**
