...
__NAME__ = "Pᴜʀɢᴇ"
__MENU__ = """
`.del` - **ᴛᴏ ᴅᴇʟᴇᴛᴇ sᴏᴍᴇᴏɴᴇ ᴍᴇssᴀɢᴇ.**
`.purge` - **ʀᴇᴘʟʏ ᴛᴏ ᴀʟʟ ᴍᴇssᴀɢᴇs ғʀᴏᴍ ʏᴏᴜʀ ʀᴇᴘʟɪᴇᴅ**
`.purgeme` - **ᴘᴜʀɢᴇᴍᴇ [ᴄᴏᴜɴᴛ]", "ᴛᴏ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇs ᴏɴʟʏ.**
`.blockword` - **ᴡᴏʀᴅ ʜᴀs ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ ʙʟᴀᴄᴋʟɪsᴛ**
`.unblockblockword` - **ᴡᴏʀᴅ ʜᴀs ʙᴇᴇɴ ʀᴇᴍᴏᴠᴇᴅ ғʀᴏᴍ ᴛʜᴇ ʙʟᴀᴄᴋʟɪsᴛ.**
